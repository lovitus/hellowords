...
- 公开版本：`v103-443050a`
- 地址：<https://hellowords-world.perky-spoon-0500.chatgpt.site/?v=103-443050a>
- 源码：`443050a`（v103 公开运行时；首页恢复为六个大区名称牌，默认不挂词泡，悬浮/聚焦时只挂当前分区的锚点词，移出后收起；根图集与子场景小地图均按真实锚点包围盒聚焦；植物细胞从 46 扩至 60 个可指认部件并拆分细胞核/内质网、类囊体、线粒体和细胞壁焦点区；此前 Apartment、列车车厢、电动公交、Polymer、衣柜、电池包、锂离子电芯、水箱等增密与连续放大修复保持不变）
