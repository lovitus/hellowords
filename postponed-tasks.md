...
- 公开源码仍冻结在 `8e3cab7039f684a434887faa76c6ba7c617ce8ea`；未发布的本地万词里程碑已推进到 `1788fa8` 之后的整批验收状态。当前累计 60 个场景、9,177 个空间锚点、8,093 个去重展示词、405 个细分区、59 个门户、6 条首页分支；距 10,000 个真实空间词还差 1,907。
...
- 当前已接入的未发布里程碑为 10,020 个去重展示词，已跨过 10,000；共 73 个现实场景、11,104 个空间锚点、72 条可进入路径。仍冻结公开发布，完成整批回归与真实入口验收后再由用户决定是否发布一个里程碑版本。
