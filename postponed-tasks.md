...
- 当前唯一游标：交付候选 `2bfaf36` 已推至 `codex/practical-conversation-expansion`，本批增加 `emergency-assessment-bay`：148个像素复核锚点、7区、3组/18句双语会话；从分诊接待区 `[1150,120,65,65]`、enterScale 3.25进入，终点放大留在本场景。锚点与入口集成角色均通过；删掉重复监护线与不存在的挡水板标签。区域计数24/24/17/24/24/19/16，LOD为7/6/32/57/46。全世界101场景、15,373锚点、14,289全局唯一展示词、656区、100门户；父/子生成器二次运行幂等。图源 PNG SHA `e0c71d09e58710929db8f78672ccc0ba5e6379aba306e5bdf5b123ee8185b734`，JPEG SHA `f8bf7333b715e7dc07d19c219444afc0eda6c95ff218a2d9eb5b79463b4e48cd`。会话依据 [NHS A&E 就诊指引](https://www.nhs.uk/nhs-services/urgent-and-emergency-care-services/when-to-go-to-ae/)、[NHS ED 初步评估](https://www.england.nhs.uk/guidance-for-emergency-departments-initial-assessment/) 和 [Leeds NHS 口译支持](https://www.leedsth.nhs.uk/patients/support/translation/)；不提供诊断/用药建议。

- 里程碑 run `35911274090`、复核 run `35912910582` 均在单测阶段失败；万词 preflight 通过，`verify:full` 在353项中352通过，未进入 build/SSR/E2E/perf。第二次仅为取得可读错误摘要，确认唯一失败是 `sceneLabelDensity`：手机首屏的 `emergency-assessment-bay` 显示10/11个词。图像阈值、锚点、LOD、portal及源码合同的只读审查均未发现问题。为减少手机气泡宽度且不动锚点，已将7个首屏主词缩短并同步内容合同；此修正尚未提交或由GitHub验证。禁止本地测试/build；下一步复用内容审查后 amend 同一批次，推送并重新运行 GitHub 完整门槛。
