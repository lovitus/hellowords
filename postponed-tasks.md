...
- 公开版本：`v78-5455b8a`
- 地址：<https://hellowords-world.perky-spoon-0500.chatgpt.site/?v=78-5455b8a>
- 源码：`5455b8a`（v78 公开运行时；水箱扩充至 50 个经像素复核的锚点，沿用场景 JSON cache-bust）
- 当前工作批次：公寓、城市街景、厨房、卧室、浴室、科学馆、铁路站台、列车车厢、城市公园、叶片、聚合物、衣柜、植物细胞、叶绿体内部、人体展柜、咖啡机、锂离子电芯、水箱、标签避让平滑度、紧凑词泡与描边、科学馆、厨房与浴室密度；语义换词/索引闪现优化、首页大区悬浮词面、电池包、电动公交部件扩展、空间滚轮和高密度标签避让流畅度修复（已发布）。首页图集、既有锚点坐标与 1,275 个根图集词保持不变。
