...
const sourceZones = [
  {
    ...
    height: 560,
    labels: [
      ["forklift", "叉车", 430, 560, 0],
      ["overhead guard", "护顶架", 455, 400, 0],
      ["forklift mast", "叉车门架", 255, 455, 1],
  ...
  },
  {
    ...
    labels: [
      ...
      ["wrapped pallet", "覆膜托盘货载", 820, 250, 1],
    ],
  },
  {
  ...
  },
  {
    ...
    labels: [
      ...
      ["roller conveyor", "滚筒输送机", 1_440, 630, 0],
      ["conveyor roller", "输送机滚筒", 1_450, 620, 1],
      ["conveyor frame", "输送机机架", 1_500, 700, 2],
      ["bench scale", "台秤", 1_060, 640, 0],
      ["scale platform", "秤台", 1_050, 615, 2],
      ["barcode scanner", "条码扫描器", 1_360, 650, 0],
      ["scanner trigger", "扫描器扳机", 1_360, 655, 4],
      ["label printer", "标签打印机", 1_405, 700, 0],
  ...
  },
  {
    ...
    labels: [
      ...
      ["door hinge", "门板铰链", 1_370, 180, 3],
      ["vertical door track", "垂直门轨", 1_280, 100, 2],
      ["dock shelter", "月台门封", 1_330, 280, 0],
