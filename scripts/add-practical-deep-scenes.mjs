...
const integrations = [
  { parentId: "emergency-department", childId: "hospital-inpatient-bedspace", title: "Hospital inpatient bedspace", description: "The right-hand emergency examination bed and its complete bedhead service area", portal: { id: "enter-hospital-inpatient-bedspace", label: "Explore the inpatient bedspace", translation: "探索住院床位区", childSceneId: "hospital-inpatient-bedspace", sourceVisualRegion: "portal-hospital-inpatient-bedspace", x: 1_090, y: 420, width: 480, height: 400, enterScale: 3.35 } },
