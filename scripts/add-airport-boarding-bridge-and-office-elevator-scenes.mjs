...
const scenes = [
  {
    ...
    zones: [
      ...
      { id: "handrails-and-threshold", title: "Handrails and boarding threshold", translation: "扶手与登机门槛", description: "Follow both continuous handrails, their brackets and the visible raised aircraft-door threshold.", x: 390, y: 300, width: 740, height: 350, targetScale: 2.7, labels: [
