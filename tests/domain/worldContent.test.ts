...
test("mature world has six subject branches and fully reachable practical paths", async () => {
  ...
  const expectedPaths = [
    ...
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "pathology-lab", "microscope-workstation"],
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "pathology-lab", "histology-sectioning-workstation"],
    ...
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "emergency-department", "intensive-care-unit", "bedside-monitor-station", "infusion-pump-rack"],
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "emergency-department", "hospital-inpatient-bedspace"],
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "emergency-department", "emergency-triage-reception"],
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "emergency-department", "emergency-triage-reception", "emergency-assessment-bay"],
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "hospital-pharmacy"],
    ["world-map", "city-street", "transit-hub", "urban-services", "hospital", "hospital-pharmacy", "automated-dispensing-cabinet"],
    ...
    ["world-map", "city-street", "transit-hub", "urban-services", "airport", "security-checkpoint", "boarding-gate", "passenger-boarding-bridge", "aircraft-cabin", "aircraft-galley-equipment"],
    ["world-map", "city-street", "transit-hub", "urban-services", "airport", "security-checkpoint", "carry-on-baggage-scanner"],
    ["world-map", "city-street", "transit-hub", "urban-services", "airport", "security-checkpoint", "boarding-gate", "passenger-boarding-bridge"],
    ["world-map", "city-street", "transit-hub", "urban-services", "airport", "security-checkpoint", "boarding-gate", "passenger-boarding-bridge", "aircraft-cabin", "aircraft-lavatory"],
    ...
    ["world-map", "city-street", "transit-hub", "urban-services", "office-building", "office-reception-lobby", "office-elevator-car"],
    ...
    ["world-map", "school-campus", "primary-classroom"],
    ...
    ["world-map", "school-campus", "school-corridor", "school-dining-hall", "school-catering-kitchen"],
    ["world-map", "school-campus", "school-corridor", "school-locker-bank"],
    ["world-map", "school-campus", "school-science-preparation-room", "school-science-laboratory"],
    ...
    ["world-map", "supermarket-grocery", "supermarket-produce-department"],
    ["world-map", "supermarket-grocery", "supermarket-produce-department", "produce-weighing-station"],
  ];
...
test("urban services adds hospital, airport and office vocabulary without breaking the transit branch", async () => {
  ...
  for (const [sceneId, count, zones, parent, required] of [
    ...
    ["emergency-triage-reception", 302, 7, "emergency-department", ["triage-left registration monitor", "patient check-in station", "triage patient chair", "triage-reception wheelchair", "triage-room door handle", "open circulation floor"]],
    ["emergency-assessment-bay", 148, 7, "emergency-triage-reception", ["assessment couch", "vitals monitor", "bedhead panel", "bay supply cart", "bay sink", "bay privacy curtain"]],
    ...
    ["histology-sectioning-workstation", 108, 6, "pathology-lab", ["rotary microtome", "rotary handwheel", "microtome specimen head", "visible cutting blade", "section catch tray", "slide water bath", "sectioning tools", "cassette basket", "microtome control panel"]],
    ...
    for (const term of required) {
      assert.ok(words.has(term.toLocaleLowerCase()), `${sceneId} visibly grounds ${term}`);
    }
  }
  assert.deepEqual(
